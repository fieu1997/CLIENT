...
public class MobMiNuong {
    public long timeUpdate;
    public short index;
    public String name ="";
    public String nameOwner="Mỵ Nương";
    public Player Owner;
    public boolean isRemove;
    public Map map;
    public short x,y;
    
    public MobMiNuong(Map map, short idx){
...
//        }
    ...
    public void MobLeave()throws IOException{
        ...
        m2.cleanup();
        map.mobEvent4.remove(this);
        Event_4.entrys.remove(this);
    }
